#ifndef HALIDE__bin___npr_h
#define HALIDE__bin___npr_h
#include <stdint.h>
...
int npr(struct halide_buffer_t *_img_input_npr_buffer, struct halide_buffer_t *_img_output_npr_buffer);

HALIDE_FUNCTION_ATTRS
int npr_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *npr_metadata();
